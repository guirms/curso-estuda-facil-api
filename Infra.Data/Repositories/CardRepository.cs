...
namespace Infra.Data.Repositories
{
    public class CardRepository(SqlContext context, IMapper mapper) : BaseSqlRepository<Card>(context), ICardRepository
    {
        ...
        public async Task<IEnumerable<GetCardResultsResponse>?> GetCardResults(int boardId, int currentPage, string? cardName, int takeQuantity = 10)
        {
            ...
            return await mapper.ProjectTo<GetCardResultsResponse>(query).ToListAsync();
        }
    }
}
